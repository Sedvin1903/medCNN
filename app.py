...
#     app.run(host='192.168.1.35', port='5500', debug=True)
from flask import Flask, render_template, request
from tensorflow.keras.preprocessing import image
import numpy as np
import os
...
def prediction():
    ...
    "Palak(Spinach), a leafy green vegetable, is used in culinary dishes. It is rich in nutrients, including iron and vitamins, and is valued for its health benefits.",
           
    "Papaya, a tropical fruit, is enjoyed for its sweet taste and nutritional content. It is rich in Vitamin C, antioxidants, and is commonly used in culinary dishes and beverages.",
           
    "Parijatha, known for its fragrant flowers, is used ornamentally. Parijatha flowers are used in garlands, decorative arrangements, and as offerings, adding beauty to gardens and events.",
           
    "Pea, a versatile vegetable, is used in culinary dishes worldwide. It is valued for its sweet taste and is employed in various savory recipes.",
           
    "Pepper, a popular spice, is used in culinary dishes worldwide. It adds flavor and heat to meals and is valued for its versatility in various recipes.",
           
    "Pomegranate, a nutrient-rich fruit, is enjoyed for its sweet taste and health benefits. It is rich in antioxidants, vitamins, and minerals, contributing to overall health when consumed.",
           
    "Pumpkin, a versatile vegetable, is used in culinary dishes worldwide. It is valued for its sweet taste and is employed in various savory recipes.",
           
    "Radish, a root vegetable, is used in culinary dishes worldwide. It adds a crisp texture and peppery flavor to meals and is valued for its versatility in various recipes.",
           
    "Rose, known for its fragrant flowers, is used ornamentally and medicinally. Rose flowers are used in perfumery, garlands, and decorative arrangements, adding a sweet scent to gardens and events.",
           
    "Sampige, known for its fragrant flowers, is used ornamentally. Sampige flowers are used in garlands, decorative arrangements, and as offerings, adding beauty to gardens and events.",
           
    "Sapota, a tropical fruit, is enjoyed for its sweet taste and nutritional content. It is rich in fiber, antioxidants, and vitamins, contributing to overall health when consumed.",
           
    "Seethaashoka, known for its fragrant flowers, is used ornamentally. Seethaashoka flowers are used in garlands, decorative arrangements, and as offerings, adding beauty to gardens and events.",
           
    "Seethapala, a tropical fruit, is enjoyed for its sweet taste and nutritional content. It is rich in fiber, antioxidants, and vitamins, contributing to overall health when consumed.",
           
    "Spinach, a leafy green vegetable, is used in culinary dishes worldwide. It is rich in iron, vitamins, and antioxidants, contributing to overall health when consumed regularly.",
           
    "Tamarind, a tropical fruit, is enjoyed for its sweet-sour taste and culinary uses. It is used in sauces, chutneys, and beverages, adding flavor to dishes.",
           
    "Taro, a starchy root vegetable, is used in culinary dishes worldwide. It adds a creamy texture and mild flavor to meals and is valued for its versatility in various recipes.",
           
    "Tecoma, known for its vibrant flowers, is used ornamentally. Tecoma flowers are used in gardens and landscaping, adding color and beauty to outdoor spaces.",
           
    "Thumbe, a traditional medicinal herb, is used for its healing properties. It is believed to have anti-inflammatory effects and is employed in traditional medicine for various ailments.",
           
    "Tomato, a versatile fruit, is used in culinary dishes worldwide. It adds flavor and acidity to meals and is valued for its versatility in various savory recipes.",
           
    "Tulsi, known for its medicinal properties, is used in traditional medicine. Tulsi leaves are believed to have immune-boosting and anti-inflammatory effects.",
           
    "Turmeric, a vibrant spice, is used in culinary dishes and traditional medicine. It adds color and flavor to meals and is valued for its potential health benefits.",
           
    "Ashoka, known for its fragrant flowers, is used ornamentally. Ashoka flowers are used in garlands, decorative arrangements, and as offerings, adding beauty to gardens and events.",
           
    "Camphor, known for its aromatic properties, is used in traditional medicine. It is believed to have anti-inflammatory and antiseptic effects and is employed for its potential health benefits.",
           
    "Kamakasturi, known for its aromatic properties, is used in traditional medicine. It is believed to have anti-inflammatory and antiseptic effects and is employed for its potential health benefits.",
           
    "Kepala, a traditional medicinal herb, is used for its healing properties. It is believed to have anti-inflammatory effects and is employed in traditional medicine for various ailments."
    ]


    prediction = leavesArray[predicted_class]
    use = usesArray[predicted_class]
    return render_template('home.html', prediction=prediction, use=use)
